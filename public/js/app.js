$(document).ready(function() {
	...
	$(Profile.Modals.AddPhoto).on('shown.bs.modal', function(e) {
		var modal = $(this);
	...
	$(Profile.Modals.AddPhoto).on('hidden.bs.modal', function(e) {
	...
	$(Profile.Modals.About).on('shown.bs.modal', function(e) {
	...
	$(Profile.Modals.About).on('hidden.bs.modal', function(e) {
		FormDecorator.clear($(this).find(".form-group"));
	});

	$(Profile.Modals.ViewPhoto).on('shown.bs.modal', function(e) {
	...
	$(Profile.Modals.ViewPhoto).on('hidden.bs.modal',function(e){
		$(this).find('#sender').val('');
	});

	$(Profile.Content.Photos).ready(function(){
		...
		$(".user-photos").on('click','a', function(e){
			...
			$(Profile.Modals.ViewPhoto).find("#sender").val(targetId);
			$(Profile.Modals.ViewPhoto).modal("show");
		});
